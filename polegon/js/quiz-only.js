...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizQuestions = [
        ...
        },
        {
            ...
            options: [
                { text: "Выхожу 1vs1 и доказываю, что скилл важнее", type: "a" },
                { text: "Ливаю как лах", type: "b" },
                { text: "Я сам(а) читер(ша)", type: "c" }
            ]
        },
        {
        ...
        },
        {
            ...
            options: [
                { text: "Рашу всё, что вижу и не вижу", type: "a" },
                { text: "Хз, как пойдёт", type: "b" },
                { text: "Прилетаю с читами и всех ем", type: "c" }
            ]
        },
        {
            question: "Что важнее в мышке?",
            options: [
                { text: "Производительность, каждый грамм на счету", type: "a" },
                { text: "Эргономика, рука не должна уставать", type: "b" },
        ...
        },
        {
            ...
            options: [
                { text: "Победа любой ценой", type: "a" },
                { text: "Главное — участие и хорошие тиммейты", type: "b" },
                { text: "Тапаю по мышечке своей тап-тап-тап", type: "c" }
            ]
        },
        {
    ...
    const quizResults = {
        a: {
            ...
            features: [
                ...
                "Встроенный детектор читеров (работает в 100% случаев, но только по пятницам)",
                "RGB-подсветка, которая ослепляет врагов через монитор",
                "Вес: 37 грамм (вместе с твоей уверенностью)"
            ],
            history: "Создана в секретной лаборатории Bloody после того, как один геймер так долго тащил катку, что его мышь эволюционировала до божественного уровня. Теперь эта мышь живёт вне времени и пространства, кликая ещё до того, как ты подумал."
        },
        b: {
            title: "Bloody A∞ ChillWave Eternal",
            emoji: "🌊",
            ...
            features: [
                ...
                "Совместима с Windows, macOS и операционной системой твоего кота"
            ],
            history: "Эта мышь была найдена в древнем храме геймерских богов. Монахи медитировали на неё 1000 лет, прежде чем она обрела просветление. Теперь она передаёт свою мудрость через каждый клик, напоминая: главное не победа, а процесс (но победа тоже неплохо)."
        },
        c: {
            ...
            features: [
                "RGB-подсветка всех 7 цветов радуги и 3 оттенков чёрного",
                ...
                "В комплекте идёт открывашка для пива (на случай если ты не мышь)"
            ],
            history: "Создана случайно, когда инженер Bloody пытался сделать самую красивую мышь в мире, но перепутал чертежи с дизайн-проектом ночного клуба. Теперь эта мышь светится так ярко, что может заменить настольную лампу. А ещё она умеет играть в бедварс лучше тебя."
        },
        d: {
            title: "Bloody A👑 Vasilisa Divine Edition",
            emoji: "👑",
            description: "Ты — легендарная Василиса. Божественное существо, превосходящее пространство, время и здравый смысл. Тебя невозможно победить, потому что ты сама решаешь, когда проигрывать.",
            features: [
            ...
            history: "Эта мышь не была создана — она всегда существовала. Древние тексты гласят, что первая Василиса появилась в момент, когда один геймер настолько сильно захотел победить, что его желание обрело форму. Теперь эта мышь передаётся только избранным, которые поняли главную истину: победа — это не цель, это образ мышления. А ещё она умеет красиво проигрывать, чтобы ты не зазнавался."
        }
    };
